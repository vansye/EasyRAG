...
> 运行时间：2026-09-22T10:48:35+08:00。由离线 CLI 生成，未调用 LLM。
...
.\.venv\Scripts\python.exe -m scripts.eval_retrieval `
  ...
  --strategy 'dense' `
  --candidates '20' `
  --output '../docs/eval/retrieval-v2-dense-2026-09-22.md'
```
...
| 4 | JavaWeb/JavaWeb后端开发/会话管理与登陆校验/Interceptor拦截器技术.md | 13 | Interceptor 拦截器技术 > 代码示例：token 登录拦截器 > 结合你项目的实际代码 `tokenInterceptor.java` | 9121:10043 | 287 | 0.574196 |
| 5 | JavaWeb/Web前端设计/Pinia状态管理.md | 8 | 3. Store 定义 > 3.2 state 状态定义 | 4374:5125 | 206 | 0.568854 |
...
| 排名 | 文档 | seq | 标题路径 | byte_start:byte_end | token | 相似度 |
|---:|---|---:|---|---|---:|---:|
| 1 | 数据库/Redis过期Key处理.md | 6 |  | 2684:3335 | 177 | 0.848635 |
| 2 | 数据库/Redis过期Key处理.md | 1 |  | 0:347 | 96 | 0.841352 |
| 3 | 数据库/Redis过期Key处理.md | 7 | 3. 惰性删除详解 > 3.1 工作原理 | 3335:3794 | 108 | 0.812310 |
| 4 | 数据库/Redis过期Key处理.md | 10 | 4. 定期删除详解 > 4.1 工作原理 | 4791:5262 | 151 | 0.807219 |
...
| 4 | 数据库/Redis过期Key处理.md | 18 | 6. 过期 Key 的内存回收 > 6.2 内存池 vs OS 内存 | 9265:9815 | 173 | 0.632549 |
| 5 | 数据库/知识条目/epoll（Linux 高并发网络模型）.md | 4 | 详细 > 重点 | 1636:2393 | 235 | 0.619235 |
...
| 2 | 数据库/知识条目/epoll（Linux 高并发网络模型）.md | 2 | 详细 > 概念 | 421:670 | 65 | 0.680698 |
| 3 | 数据库/知识条目/epoll（Linux 高并发网络模型）.md | 3 | 详细 > 重点 | 670:1636 | 298 | 0.655917 |
| 4 | 数据库/知识条目/epoll（Linux 高并发网络模型）.md | 4 | 详细 > 重点 | 1636:2393 | 235 | 0.624497 |
| 5 | 数据库/Redis/Redis持久化.md | 15 |  | 8584:9192 | 199 | 0.541813 |
...
| 2 | 数据库/Redis/Redis持久化.md | 1 |  | 0:344 | 97 | 0.629350 |
| 3 | 数据库/Redis/Redis持久化.md | 29 | 小结 | 16005:16678 | 207 | 0.608760 |
| 4 | 数据库/Redis过期Key处理.md | 20 | 7. 常见问题与陷阱 > 7.1 陷阱一：过期 ≠ 立即删除 | 10474:11026 | 165 | 0.607189 |
| 5 | 数据库/Redis过期Key处理.md | 26 | 小结 | 12974:13731 | 227 | 0.602319 |
...
| 2 | JavaWeb/知识条目/前端/onMounted生命周期函数.md | 2 | 详细 > 概念 | 382:612 | 74 | 0.738476 |
| 3 | JavaWeb/知识条目/前端/onMounted生命周期函数.md | 1 |  | 0:382 | 105 | 0.709261 |
| 4 | JavaWeb/Web前端设计/Pinia状态管理.md | 21 | 8. Store 与路由的配合 > 8.2 页面初始化数据 | 15165:15649 | 183 | 0.599017 |
| 5 | JavaWeb/Web前端设计/Pinia状态管理.md | 3 | 1. 为什么需要状态管理 | 1509:2346 | 253 | 0.540360 |
...
| 2 | 数据库/知识条目/Redis 事务.md | 1 |  | 0:344 | 91 | 0.613007 |
| 3 | 数据库/Redis/Redis持久化.md | 17 | 4. 混合持久化 > 4.2 配置 | 10088:10315 | 89 | 0.603504 |
| 4 | 数据库/Redis/Redis持久化.md | 22 | 6. 生产环境配置方案 > 6.2 方案二：AOF only（数据敏感场景） | 12317:12696 | 139 | 0.598877 |
| 5 | 数据库/知识条目/Redis 事务.md | 2 | 详细 > 概念 | 344:621 | 68 | 0.597637 |
...
| 2 | JavaWeb/知识条目/部署/Docker/Docker 镜像.md | 3 | 详细 > 重点 | 666:1785 | 344 | 0.609425 |
| 3 | JavaWeb/知识条目/部署/Docker/Docker 数据卷（Volume）.md | 2 | 详细 > 重点 | 549:1867 | 436 | 0.604151 |
| 4 | JavaWeb/知识条目/部署/Docker/Docker 数据卷（Volume）.md | 1 |  | 0:549 | 134 | 0.596856 |
...
| 排名 | 文档 | seq | 标题路径 | byte_start:byte_end | token | 相似度 |
|---:|---|---:|---|---|---:|---:|
| 1 | JavaWeb/Web前端设计/Pinia状态管理.md | 28 | 10. 常见用法总结 > 10.4 响应式追踪 | 19175:19480 | 105 | 0.497242 |
| 2 | JavaWeb/知识条目/后端/Bean.md | 1 |  | 0:407 | 104 | 0.494709 |
| 3 | 数据库/Redis/Redis持久化.md | 24 |  | 13171:14059 | 310 | 0.491508 |
| 4 | JavaWeb/Web前端设计/Pinia状态管理.md | 18 | 6. 状态持久化 > 6.2 使用 pinia-plugin-persistedstate（推荐） | 12796:13696 | 291 | 0.473261 |
| 5 | JavaWeb/知识条目/前端/onMounted生命周期函数.md | 2 | 详细 > 概念 | 382:612 | 74 | 0.463516 |
...
| 2 | 大模型应用/知识条目/KV Cache.md | 10 | KV Cache（键值缓存）深度知识概览 > 五、 针对 KV Cache 的顶尖优化策略 > 4. FlashAttention / FlashDecoding | 4009:4202 | 92 | 0.552868 |
| 3 | 大模型应用/知识条目/KV Cache.md | 7 | KV Cache（键值缓存）深度知识概览 > 五、 针对 KV Cache 的顶尖优化策略 > 1. 多查询注意力（MQA）与分组查询注意力（GQA） | 2872:3316 | 182 | 0.538933 |
| 4 | 大模型应用/知识条目/KV Cache.md | 1 |  | 0:708 | 187 | 0.528928 |
| 5 | 大模型应用/知识条目/KV Cache.md | 4 | KV Cache（键值缓存）深度知识概览 > 三、 工作机制（底层原理解析） > 2. 注意力计算的变化 | 1954:2187 | 113 | 0.512580 |
...
| 2 | 数据库/Redis过期Key处理.md | 6 |  | 2684:3335 | 177 | 0.737045 |
| 3 | 数据库/Redis过期Key处理.md | 22 | 7. 常见问题与陷阱 > 7.3 陷阱三：批量过期导致性能抖动 | 11297:11867 | 180 | 0.725724 |
| 4 | 数据库/Redis过期Key处理.md | 10 | 4. 定期删除详解 > 4.1 工作原理 | 4791:5262 | 151 | 0.725693 |
| 5 | 数据库/Redis过期Key处理.md | 18 | 6. 过期 Key 的内存回收 > 6.2 内存池 vs OS 内存 | 9265:9815 | 173 | 0.707263 |
...
| 排名 | 文档 | seq | 标题路径 | byte_start:byte_end | token | 相似度 |
|---:|---|---:|---|---|---:|---:|
| 1 | 大模型应用/知识条目/invoke、stream 与 batch.md | 2 | 详细 > 概念 | 291:885 | 156 | 0.636892 |
| 2 | 大模型应用/知识条目/invoke、stream 与 batch.md | 3 | 详细 > 重点 | 885:2264 | 390 | 0.633183 |
| 3 | 大模型应用/LangChain 1.0/核心组件/message/多轮对话.md | 1 |  | 0:385 | 106 | 0.628384 |
| 4 | 大模型应用/LangChain 1.0/核心组件/Agent/create_agent 与 Agent 输入输出.md | 17 | 小结 | 14731:15494 | 233 | 0.620216 |
| 5 | 大模型应用/知识条目/LangChain 1.0 LCEL 表达式语言.md | 2 | 详细 > 概念 | 270:981 | 193 | 0.602490 |
