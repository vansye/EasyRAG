...
> 运行时间：2026-09-22T22:28:49+08:00。由离线 CLI 生成，未调用 LLM。
...
|---|---:|---:|---:|---:|
| Q | 12/12（100.00%） | 12/12（100.00%） | 12/12（100.00%） | 12/12（100.00%） |
| R | 3/3（100.00%） | 3/3（100.00%） | 3/3（100.00%） | 3/3（100.00%） |
| Q+R | 15/15（100.00%） | 15/15（100.00%） | 15/15（100.00%） | 15/15（100.00%） |
...
.\.venv\Scripts\python.exe -m scripts.eval_retrieval `
  ...
  --strategy 'hybrid' `
  --candidates '20' `
  --output '../docs/eval/retrieval-v3-hybrid-2026-09-22.md'
```
...
| 2 | 数据库/Redis/Redis持久化.md | 29 | 小结 | 16005:16678 | 207 | 0.612650 |
| 3 | 数据库/Redis/Redis持久化.md | 27 | 7. 故障恢复与数据一致性 > 7.3 手动恢复流程 | 14965:15606 | 240 | 0.602185 |
| 4 | 数据库/Redis/Redis持久化.md | 16 | 4. 混合持久化 > 4.1 什么是混合持久化 | 9192:10088 | 231 | 0.620280 |
| 5 | 数据库/Redis/Redis持久化.md | 25 | 7. 故障恢复与数据一致性 > 7.1 正常重启恢复顺序 | 14059:14481 | 142 | 0.601539 |
...
| 4 | 数据库/Redis/Redis持久化.md | 5 | 2. RDB（快照持久化） > 2.1 工作原理 | 2169:3004 | 191 | 0.449436 |
| 5 | 数据库/Redis/Redis持久化.md | 24 |  | 13171:14059 | 310 | 0.499454 |
...
| 2 | 数据库/Redis过期Key处理.md | 11 | 4. 定期删除详解 > 4.2 内部实现细节 | 5262:6074 | 246 | 0.628991 |
| 3 | 数据库/Redis过期Key处理.md | 26 | 小结 | 12974:13731 | 227 | 0.508027 |
| 4 | 数据库/Redis/Redis持久化.md | 12 | 3. AOF（追加日志持久化） > 3.3 三种刷盘策略详解 | 5504:6530 | 321 | 0.465580 |
| 5 | 数据库/Redis/Redis持久化.md | 11 | 3. AOF（追加日志持久化） > 3.2 核心配置 | 5139:5504 | 113 | 0.459363 |
...
| 3 | 大模型应用/LangChain 1.0/核心组件/message/多轮对话.md | 8 |  | 4730:5253 | 170 | 0.387030 |
| 4 | JavaWeb/JavaWeb后端开发/会话管理与登陆校验/Interceptor拦截器技术.md | 20 | Interceptor 拦截器技术 > Interceptor 与 Filter 的区别 | 13232:13963 | 277 | 0.383972 |
| 5 | 大模型应用/知识条目/KV Cache.md | 11 | KV Cache（键值缓存）深度知识概览 > 六、 RAG 与 KV Cache 的密切关系 | 4202:4839 | 225 | 0.381429 |
...
| 3 | 数据库/知识条目/epoll（Linux 高并发网络模型）.md | 2 | 详细 > 概念 | 421:670 | 65 | 0.549855 |
| 4 | 数据库/知识条目/epoll（Linux 高并发网络模型）.md | 4 | 详细 > 重点 | 1636:2393 | 235 | 0.462945 |
| 5 | 大模型应用/LangChain 1.0/核心组件/Agent/create_agent 与 Agent 输入输出.md | 17 | 小结 | 14731:15494 | 233 | 0.408177 |
...
| 3 | 数据库/知识条目/缓存.md | 3 | 详细 > 重点 | 731:2293 | 423 | 0.597044 |
| 4 | 数据库/Redis/Redis持久化.md | 17 | 4. 混合持久化 > 4.2 配置 | 10088:10315 | 89 | 0.545271 |
| 5 | 数据库/Redis/Redis持久化.md | 3 | 1. 为什么需要持久化 > 1.1 Redis 的内存特性 | 909:1800 | 224 | 0.567301 |
...
| 5 | JavaWeb/知识条目/后端/Bean.md | 2 | 详细 > 重点 | 407:691 | 80 | 0.515196 |
...
| 3 | JavaWeb/知识条目/前端/onMounted生命周期函数.md | 3 | 详细 > 重点 | 612:1620 | 322 | 0.430873 |
| 4 | JavaWeb/JavaWeb后端开发/会话管理与登陆校验/Interceptor拦截器技术.md | 20 | Interceptor 拦截器技术 > Interceptor 与 Filter 的区别 | 13232:13963 | 277 | 0.427091 |
| 5 | 数据库/知识条目/ACID.md | 3 | 详细 > 重点 | 677:1848 | 299 | 0.428808 |
...
| 排名 | 文档 | seq | 标题路径 | byte_start:byte_end | token | 相似度 |
|---:|---|---:|---|---|---:|---:|
| 1 | 数据库/知识条目/操作系统缓冲区（OS Buffer）.md | 2 | 详细 > 概念 | 456:757 | 85 | 0.555779 |
| 2 | 数据库/知识条目/缓存.md | 1 |  | 0:365 | 97 | 0.561220 |
| 3 | 数据库/知识条目/操作系统缓冲区（OS Buffer）.md | 1 |  | 0:456 | 130 | 0.533753 |
| 4 | 数据库/知识条目/缓存.md | 3 | 详细 > 重点 | 731:2293 | 423 | 0.545704 |
| 5 | 数据库/知识条目/操作系统缓冲区（OS Buffer）.md | 3 | 详细 > 重点 | 757:1905 | 356 | 0.528357 |
...
| 2 | 数据库/知识条目/ACID.md | 1 |  | 0:345 | 89 | 0.514443 |
| 3 | JavaWeb/知识条目/后端/Tomcat.md | 1 |  | 0:450 | 121 | 0.679238 |
| 4 | JavaWeb/JavaWeb后端开发/会话管理与登陆校验/Interceptor拦截器技术.md | 4 | Interceptor 拦截器技术 | 1560:3447 | 343 | 0.577947 |
| 5 | 数据库/知识条目/ACID.md | 2 | 详细 > 概念 | 345:677 | 90 | 0.484169 |
...
| 4 | JavaWeb/Web前端设计/Pinia状态管理.md | 28 | 10. 常见用法总结 > 10.4 响应式追踪 | 19175:19480 | 105 | 0.620184 |
| 5 | JavaWeb/Web前端设计/Pinia状态管理.md | 23 | 9. 完整 Store 示例 | 16056:17155 | 354 | 0.545141 |
...
| 4 | 数据库/知识条目/缓存.md | 3 | 详细 > 重点 | 731:2293 | 423 | 0.496802 |
| 5 | JavaWeb/JavaWeb后端开发/会话管理与登陆校验/Interceptor拦截器技术.md | 16 | Interceptor 拦截器技术 > 拦截路径的配置 > `addPathPatterns()` 配置要拦截的路径 | 11397:11765 | 161 | 0.520720 |
...
| 2 | 数据库/知识条目/操作系统缓冲区（OS Buffer）.md | 2 | 详细 > 概念 | 456:757 | 85 | 0.438757 |
| 3 | 数据库/知识条目/操作系统缓冲区（OS Buffer）.md | 1 |  | 0:456 | 130 | 0.457793 |
| 4 | 数据库/知识条目/epoll（Linux 高并发网络模型）.md | 2 | 详细 > 概念 | 421:670 | 65 | 0.426586 |
| 5 | 数据库/知识条目/epoll（Linux 高并发网络模型）.md | 1 |  | 0:421 | 120 | 0.425611 |
...
| 2 | 数据库/知识条目/epoll（Linux 高并发网络模型）.md | 3 | 详细 > 重点 | 670:1636 | 298 | 0.622164 |
| 3 | 数据库/知识条目/epoll（Linux 高并发网络模型）.md | 1 |  | 0:421 | 120 | 0.641406 |
...
| 4 | 数据库/Redis/Redis持久化.md | 6 | 2. RDB（快照持久化） > 2.2 RDB 文件特点 | 3004:3265 | 93 | 0.522564 |
...
| 2 | 数据库/Redis/Redis持久化.md | 28 | 7. 故障恢复与数据一致性 > 7.4 AOF 文件损坏处理 | 15606:16005 | 149 | 0.757850 |
| 3 | 数据库/Redis/Redis持久化.md | 25 | 7. 故障恢复与数据一致性 > 7.1 正常重启恢复顺序 | 14059:14481 | 142 | 0.678273 |
...
| 4 | 大模型应用/LangChain 1.0/核心组件/message/多轮对话.md | 1 |  | 0:385 | 106 | 0.624408 |
...
| 4 | 大模型应用/知识条目/Tools.md | 1 |  | 0:260 | 74 | 0.579545 |
| 5 | 大模型应用/LangChain 1.0/核心组件/Agent/create_agent 与 Agent 输入输出.md | 14 | 5. 完整实战：多工具 Agent | 8598:9696 | 296 | 0.608929 |
