...
> 运行时间：2026-09-22T22:28:21+08:00。由离线 CLI 生成，未调用 LLM。

## 验收边界

本报告只验证切片与索引的离线召回；资料收录、更新同步、业务问答与完整评估平台需各自的验收证据。
不实现 Agent、改写、重排、拒答或部分覆盖判断；不读取 MySQL，不打开业务持久化 Chroma。
检索策略：bm25——只用 BM25（jieba 分词，语料为正文 + 标题路径）排序，相似度列仍报向量余弦。

## 召回结果

| 类别 | hit@1 | hit@3 | hit@5 | hit@10 |
|---|---:|---:|---:|---:|
| Q | 11/12（91.67%） | 12/12（100.00%） | 12/12（100.00%） | 12/12（100.00%） |
| R | 3/3（100.00%） | 3/3（100.00%） | 3/3（100.00%） | 3/3（100.00%） |
| Q+R | 14/15（93.33%） | 15/15（100.00%） | 15/15（100.00%） | 15/15（100.00%） |
...
.\.venv\Scripts\python.exe -m scripts.eval_retrieval `
  ...
  --strategy 'bm25' `
  --candidates '20' `
  --output '../docs/eval/retrieval-v3-bm25-2026-09-22.md'
```
...
| 2 | 数据库/Redis/Redis持久化.md | 27 | 7. 故障恢复与数据一致性 > 7.3 手动恢复流程 | 14965:15606 | 240 | 0.602185 |
| 3 | 数据库/Redis/Redis持久化.md | 29 | 小结 | 16005:16678 | 207 | 0.612650 |
| 4 | 数据库/Redis/Redis持久化.md | 25 | 7. 故障恢复与数据一致性 > 7.1 正常重启恢复顺序 | 14059:14481 | 142 | 0.601539 |
| 5 | JavaWeb/Web前端设计/Pinia状态管理.md | 28 | 10. 常见用法总结 > 10.4 响应式追踪 | 19175:19480 | 105 | 0.428613 |
...
| 排名 | 文档 | seq | 标题路径 | byte_start:byte_end | token | 相似度 |
|---:|---|---:|---|---|---:|---:|
| 1 | 数据库/知识条目/操作系统缓冲区（OS Buffer）.md | 3 | 详细 > 重点 | 757:1905 | 356 | 0.494750 |
| 2 | 数据库/知识条目/epoll（Linux 高并发网络模型）.md | 1 |  | 0:421 | 120 | 0.477618 |
| 3 | 数据库/知识条目/epoll（Linux 高并发网络模型）.md | 2 | 详细 > 概念 | 421:670 | 65 | 0.483138 |
| 4 | JavaWeb/知识条目/后端/Tomcat.md | 1 |  | 0:450 | 121 | 0.386805 |
| 5 | 数据库/Redis/Redis持久化.md | 5 | 2. RDB（快照持久化） > 2.1 工作原理 | 2169:3004 | 191 | 0.449436 |
...
| 排名 | 文档 | seq | 标题路径 | byte_start:byte_end | token | 相似度 |
|---:|---|---:|---|---|---:|---:|
| 1 | 数据库/Redis过期Key处理.md | 12 | 4. 定期删除详解 > 4.3 可调参数 | 6074:6603 | 156 | 0.540530 |
| 2 | 数据库/Redis/Redis持久化.md | 11 | 3. AOF（追加日志持久化） > 3.2 核心配置 | 5139:5504 | 113 | 0.459363 |
| 3 | 数据库/Redis/Redis持久化.md | 12 | 3. AOF（追加日志持久化） > 3.3 三种刷盘策略详解 | 5504:6530 | 321 | 0.465580 |
| 4 | 大模型应用/LangChain 1.0/核心组件/Agent/create_agent 与 Agent 输入输出.md | 17 | 小结 | 14731:15494 | 233 | 0.430773 |
| 5 | 数据库/Redis过期Key处理.md | 16 |  | 8407:8939 | 157 | 0.421901 |
...
| 2 | 大模型应用/LangChain 1.0/核心组件/message/多轮对话.md | 8 |  | 4730:5253 | 170 | 0.387030 |
| 3 | JavaWeb/JavaWeb后端开发/会话管理与登陆校验/Interceptor拦截器技术.md | 20 | Interceptor 拦截器技术 > Interceptor 与 Filter 的区别 | 13232:13963 | 277 | 0.383972 |
| 4 | JavaWeb/JavaWeb后端开发/会话管理与登陆校验/Interceptor拦截器技术.md | 1 | Interceptor 拦截器技术 | 0:668 | 213 | 0.259785 |
| 5 | 大模型应用/知识条目/KV Cache.md | 12 | KV Cache（键值缓存）深度知识概览 > 七、 总结：关键时间节点速记 | 4839:5543 | 221 | 0.428821 |
...
| 2 | 数据库/知识条目/epoll（Linux 高并发网络模型）.md | 1 |  | 0:421 | 120 | 0.507402 |
| 3 | 数据库/知识条目/epoll（Linux 高并发网络模型）.md | 4 | 详细 > 重点 | 1636:2393 | 235 | 0.462945 |
| 4 | 数据库/知识条目/epoll（Linux 高并发网络模型）.md | 2 | 详细 > 概念 | 421:670 | 65 | 0.549855 |
| 5 | JavaWeb/JavaWeb后端开发/会话管理与登陆校验/Interceptor拦截器技术.md | 20 | Interceptor 拦截器技术 > Interceptor 与 Filter 的区别 | 13232:13963 | 277 | 0.389397 |
...
| 3 | 数据库/Redis过期Key处理.md | 2 |  | 347:921 | 190 | 0.536061 |
| 4 | 数据库/Redis/Redis持久化.md | 17 | 4. 混合持久化 > 4.2 配置 | 10088:10315 | 89 | 0.545271 |
| 5 | JavaWeb/Web前端设计/Pinia状态管理.md | 2 | 目录 | 566:1509 | 344 | 0.499348 |
...
| 2 | JavaWeb/知识条目/部署/Docker/Docker 镜像.md | 1 |  | 0:306 | 88 | 0.528514 |
| 3 | JavaWeb/知识条目/部署/Docker/Docker 数据卷（Volume）.md | 2 | 详细 > 重点 | 549:1867 | 436 | 0.621177 |
| 4 | JavaWeb/知识条目/部署/Docker/Docker 镜像.md | 3 | 详细 > 重点 | 666:1785 | 344 | 0.499866 |
| 5 | JavaWeb/JavaWeb后端开发/会话管理与登陆校验/Interceptor拦截器技术.md | 4 | Interceptor 拦截器技术 | 1560:3447 | 343 | 0.491746 |
...
| 3 | JavaWeb/JavaWeb后端开发/会话管理与登陆校验/Interceptor拦截器技术.md | 3 | Interceptor 拦截器技术 > 什么是 Interceptor > 核心特点 | 1171:1560 | 128 | 0.393572 |
| 4 | JavaWeb/知识条目/前端/onMounted生命周期函数.md | 3 | 详细 > 重点 | 612:1620 | 322 | 0.430873 |
| 5 | 数据库/Redis过期Key处理.md | 5 | 1. 过期时间设置命令 > 1.3 过期时间不可靠的场景 | 1957:2684 | 206 | 0.333664 |
...
| 排名 | 文档 | seq | 标题路径 | byte_start:byte_end | token | 相似度 |
|---:|---|---:|---|---|---:|---:|
| 1 | 大模型应用/知识条目/Rag.md | 1 |  | 0:626 | 157 | 0.415687 |
| 2 | 数据库/知识条目/操作系统缓冲区（OS Buffer）.md | 2 | 详细 > 概念 | 456:757 | 85 | 0.555779 |
| 3 | 数据库/知识条目/epoll（Linux 高并发网络模型）.md | 1 |  | 0:421 | 120 | 0.487974 |
| 4 | JavaWeb/JavaWeb后端开发/会话管理与登陆校验/Interceptor拦截器技术.md | 5 | Interceptor 拦截器技术 > Interceptor 的工作原理 > 三个关键方法 | 3447:4051 | 229 | 0.472915 |
| 5 | JavaWeb/JavaWeb后端开发/会话管理与登陆校验/Interceptor拦截器技术.md | 20 | Interceptor 拦截器技术 > Interceptor 与 Filter 的区别 | 13232:13963 | 277 | 0.436480 |
...
| 2 | 数据库/知识条目/ACID.md | 2 | 详细 > 概念 | 345:677 | 90 | 0.484169 |
| 3 | 数据库/知识条目/ACID.md | 1 |  | 0:345 | 89 | 0.514443 |
| 4 | 数据库/知识条目/缓存.md | 3 | 详细 > 重点 | 731:2293 | 423 | 0.458033 |
| 5 | 数据库/知识条目/Redis 事务.md | 2 | 详细 > 概念 | 344:621 | 68 | 0.430291 |
...
| 2 | JavaWeb/Web前端设计/Pinia状态管理.md | 29 | 小结 | 19480:20358 | 252 | 0.612527 |
| 3 | JavaWeb/Web前端设计/Pinia状态管理.md | 16 |  | 11430:12139 | 202 | 0.597387 |
| 4 | JavaWeb/Web前端设计/Pinia状态管理.md | 23 | 9. 完整 Store 示例 | 16056:17155 | 354 | 0.545141 |
| 5 | JavaWeb/Web前端设计/Pinia状态管理.md | 14 | 5. 多 Store 架构 > 5.1 user Store | 8376:9743 | 434 | 0.525061 |
...
| 4 | 数据库/Redis/Redis持久化.md | 7 | 2. RDB（快照持久化） > 2.3 触发方式 | 3265:4067 | 251 | 0.408885 |
| 5 | 数据库/Redis/Redis持久化.md | 11 | 3. AOF（追加日志持久化） > 3.2 核心配置 | 5139:5504 | 113 | 0.423312 |
...
| 2 | 数据库/知识条目/epoll（Linux 高并发网络模型）.md | 2 | 详细 > 概念 | 421:670 | 65 | 0.426586 |
| 3 | 数据库/知识条目/epoll（Linux 高并发网络模型）.md | 1 |  | 0:421 | 120 | 0.425611 |
| 4 | 数据库/知识条目/操作系统缓冲区（OS Buffer）.md | 2 | 详细 > 概念 | 456:757 | 85 | 0.438757 |
| 5 | 数据库/知识条目/epoll（Linux 高并发网络模型）.md | 4 | 详细 > 重点 | 1636:2393 | 235 | 0.426540 |
...
| 2 | JavaWeb/Web前端设计/Pinia状态管理.md | 29 | 小结 | 19480:20358 | 252 | 0.555399 |
| 3 | JavaWeb/Web前端设计/Pinia状态管理.md | 1 |  | 0:566 | 139 | 0.551378 |
| 4 | JavaWeb/Web前端设计/Pinia状态管理.md | 2 | 目录 | 566:1509 | 344 | 0.531599 |
| 5 | JavaWeb/Web前端设计/Pinia状态管理.md | 4 | 2. Pinia 简介 | 2346:2749 | 127 | 0.495029 |
...
| 排名 | 文档 | seq | 标题路径 | byte_start:byte_end | token | 相似度 |
|---:|---|---:|---|---|---:|---:|
| 1 | 数据库/知识条目/epoll（Linux 高并发网络模型）.md | 3 | 详细 > 重点 | 670:1636 | 298 | 0.622164 |
| 2 | 数据库/知识条目/epoll（Linux 高并发网络模型）.md | 1 |  | 0:421 | 120 | 0.641406 |
| 3 | 数据库/知识条目/epoll（Linux 高并发网络模型）.md | 2 | 详细 > 概念 | 421:670 | 65 | 0.705564 |
...
| 排名 | 文档 | seq | 标题路径 | byte_start:byte_end | token | 相似度 |
|---:|---|---:|---|---|---:|---:|
| 1 | JavaWeb/知识条目/部署/Docker/Docker 数据卷（Volume）.md | 2 | 详细 > 重点 | 549:1867 | 436 | 0.703895 |
| 2 | JavaWeb/知识条目/部署/Docker/Docker 数据卷（Volume）.md | 1 |  | 0:549 | 134 | 0.737631 |
| 3 | 数据库/Redis/Redis持久化.md | 6 | 2. RDB（快照持久化） > 2.2 RDB 文件特点 | 3004:3265 | 93 | 0.522564 |
| 4 | 数据库/Redis/Redis持久化.md | 9 |  | 4408:4914 | 168 | 0.517622 |
| 5 | 数据库/Redis/Redis持久化.md | 19 | 5. RDB vs AOF 深度对比 > 5.1 全面对比表 | 10735:11362 | 243 | 0.507064 |
...
| 排名 | 文档 | seq | 标题路径 | byte_start:byte_end | token | 相似度 |
|---:|---|---:|---|---|---:|---:|
| 1 | 数据库/Redis/Redis持久化.md | 27 | 7. 故障恢复与数据一致性 > 7.3 手动恢复流程 | 14965:15606 | 240 | 0.711894 |
| 2 | 数据库/Redis/Redis持久化.md | 25 | 7. 故障恢复与数据一致性 > 7.1 正常重启恢复顺序 | 14059:14481 | 142 | 0.678273 |
| 3 | 数据库/Redis/Redis持久化.md | 28 | 7. 故障恢复与数据一致性 > 7.4 AOF 文件损坏处理 | 15606:16005 | 149 | 0.757850 |
| 4 | 数据库/Redis/Redis持久化.md | 29 | 小结 | 16005:16678 | 207 | 0.681045 |
| 5 | 数据库/Redis/Redis持久化.md | 13 | 3. AOF（追加日志持久化） > 3.4 AOF 重写（Compaction） | 6530:7346 | 248 | 0.654259 |
...
| 2 | 大模型应用/LangChain 1.0/核心组件/message/多轮对话.md | 10 |  | 6700:7440 | 241 | 0.642755 |
| 3 | 大模型应用/LangChain 1.0/核心组件/message/多轮对话.md | 21 | 小结 | 15399:16078 | 196 | 0.619978 |
| 4 | 大模型应用/LangChain 1.0/核心组件/message/多轮对话.md | 3 | 1. 多轮对话的基本原理 > 1.1 单轮 vs 多轮的差异 | 1026:1774 | 218 | 0.591972 |
| 5 | 大模型应用/知识条目/KV Cache.md | 1 |  | 0:708 | 187 | 0.515193 |
...
| 3 | 大模型应用/知识条目/Tools.md | 1 |  | 0:260 | 74 | 0.579544 |
| 4 | 大模型应用/LangChain 1.0/核心组件/Agent/create_agent 与 Agent 输入输出.md | 5 |  | 3393:5047 | 426 | 0.555575 |
| 5 | 大模型应用/LangChain 1.0/核心组件/Agent/create_agent 与 Agent 输入输出.md | 4 | 2. `create_agent` 参数详解 > 2.1 必选参数 | 2472:3393 | 310 | 0.546648 |
