...
| B retrieval | 切片、tokenizer、embedding、Chroma、由载荷派生的 BM25 与排名融合、索引清理、哪些片段进索引 | split、index_representatives、replace、delete_document、search、inspect、reset、health；离线评估复用 tokenize / LexicalIndex / fuse_rankings |
